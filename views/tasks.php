...
// Tasks Query
$query = "SELECT * FROM tasks WHERE $where_clause ORDER BY $order_by LIMIT $limit OFFSET $offset";
...
<body class="p-4">
    ...
    <header class="glass max-w-7xl mx-auto mb-6 flex justify-between items-center p-4">
        ...
        <div class="flex gap-3 items-center">
            ...
            <a href="dashboard.php" class="btn btn-danger"><i class="fas fa-sign-out-alt"></i> گەڕانەوە</a>
        </div>
    </header>
